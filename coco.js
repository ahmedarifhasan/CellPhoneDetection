...
(this, (function (e, a, i) {
    ...
    function n(e, a, i, n) {
        return new(i || (i = Promise))((function (m, t) {
            ...
            function o(e) {
                e.done ? m(e.value) : new i((function (a) {
                    a(e.value)
                })).then(d, s)
            }
    ...
    var d = function () {
        function e(e, a) {
            this.modelPath = a || "https://storage.googleapis.com/tfjs-models/savedmodel/" + "ssd_mobilenet_v2" + "/model.json"
        }
            ...
            return n(this, void 0, void 0, (function () {
                ...
                return m(this, (function (m) {
                    switch (m.label) {
                        ...
                        case 2:
                            return t = m.sent(), [4, Promise.all(t.map((function (e) {
                                return e.data()
                            })))];
                        case 3:
                            return m.sent(), t.map((function (e) {
                                return e.dispose()
                            })), n.dispose(), [2]
                    }
                }))
            ...
            return n(this, void 0, void 0, (function () {
                ...
                return m(this, (function (m) {
                    switch (m.label) {
                        ...
                        case 1:
                            return o = m.sent(), r = o[0].dataSync(), l = o[1].dataSync(), n.dispose(), i.dispose(o), p = this.calculateMaxScores(r, o[0].shape[1], o[0].shape[2]), c = p[0], y = p[1], u = i.getBackend(), i.setBackend("cpu"), f = i.tidy((function () {
                                var e = i.tensor2d(l, [o[1].shape[1], o[1].shape[3]]);
                                return i.image.nonMaxSuppression(e, c, a, t, t)
                            })), b = f.dataSync(), f.dispose(), i.setBackend(u), [2, this.buildDetectedObjects(s, d, l, c, b, y)]
                    }
                }))
            }))
    ...
    }, e.version = "2.1.0", Object.defineProperty(e, "__esModule", {
        value: !0
    })
}));